            ...
            <div class="navbar-collapse" id="navbar-mobile">
                <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                    ...
                    <ul class="nav navbar-nav bookmark-icons">
                        ...
                        <li class="nav-item d-none d-lg-block"><a class="nav-link"  data-toggle="tooltip" data-placement="top" title="لیست انجام کار"><i class="ficon feather icon-check-square"></i></a></li>
                        <li class="nav-item d-none d-lg-block"><a class="nav-link"  data-toggle="tooltip" data-placement="top" title="گفتگو"><i class="ficon feather icon-message-square"></i></a></li>
                        <li class="nav-item d-none d-lg-block"><a class="nav-link"  data-toggle="tooltip" data-placement="top" title="ایمیل"><i class="ficon feather icon-mail"></i></a></li>
                        <li class="nav-item d-none d-lg-block"><a class="nav-link"  data-toggle="tooltip" data-placement="top" title="تقویم"><i class="ficon feather icon-calendar"></i></a></li>
                    </ul>
                    <ul class="nav navbar-nav">
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600">جواد محمدی</span><span class="user-status">دردسترس</span></div><span><img class="round" src="/dashboard/app-assets/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40"></span></a>
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" ><i class="feather icon-user"></i> ویرایش نمایه</a><a class="dropdown-item" href=""><i class="feather icon-mail"></i> صندوق ورودی من</a><a class="dropdown-item" href=""><i class="feather icon-check-square"></i> برنامه ها</a><a class="dropdown-item" href=""><i class="feather icon-message-square"></i> گفتگوها</a>
                            <div class="dropdown-divider"></div><a class="dropdown-item" href=""><i class="feather icon-power"></i> خروج</a>
                        </div>
                    </li>
                </ul>
            </div>
