                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            @endif
                            <form class="form" method="post" action="{{route('dashboard_shop_basket_sending_method_update', $data->id)}}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <fieldset class="form-group">
                                                    <input type="number"  class="form-control" placeholder="مبلغ" name="price" value="{{$data->price}}">
                                                </fieldset>
                                            </div>
                                        </div>
