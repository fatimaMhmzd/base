            ...
            <div class="container">
                <nav class="blog-nav">
                    <ul class="menu-cat entry-filter justify-content-center">
                        <li class="{{ Request::routeIs('blog_blog') ? 'active' : '' }}"><a href="/blog/blog" data-filter="*">همه اخبار</a></li>
                        @foreach($data->groups as $group)
                            <li class="{{ Request::routeIs('blog_blog' ,'slug=',$group->slug) ? 'active' : '' }}"><a href="/blog/blog?slug={{$group->slug}}"
                                   data-filter=".{{$group->sub_title??null}}">{{$group->title??null}}</a></li>
                        @endforeach
                            ...
                            <article class="entry entry-grid text-center">
                                <figure class="entry-media">
                                    <a href={{route('blog_blogDetail', $blog->slug)}}>
                                        <img
                                            src="{{$blog->image ? "/".$blog->image->url : "/assets/images/blog/grid/3cols/post-1.jpg"}}"
                                            alt="توضیحات عکس">
                                    </a>
...
{{--
                    <div class="entry-item lifestyle shopping col-sm-6 col-lg-4">
                        <article class="entry entry-grid text-center">
                            <figure class="entry-media">
                                <a href={{route('blog_blogDetail', $data->groups[0]->slug)}}>
                            ...
                            <div class="entry-body">
                                ...
                                <h2 class="entry-title text-center">
                                    <a href={{route('blog_blogDetail', $data->groups[0]->slug)}}>لورم ایپسوم متن ساختگی
                                        با تولید سادگی</a>
                                </h2><!-- End .entry-title -->
                                ...
                                <div class="entry-content text-center">
                                    ...
                                    <a href={{route('blog_blogDetail', $data->groups[0]->slug)}} class="read-more">ادامه
                                        خواندن</a>
                                </div><!-- End .entry-content -->
                            </div><!-- End .entry-body -->
                        </article><!-- End .entry -->
