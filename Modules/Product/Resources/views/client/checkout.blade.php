                            ...
                            <div class="col-lg-9">
                                ...
                                <div id="addressSelect" style="display: none">
                                    <div class="col-sm-12">
                                        ...
                                        <select class="form-control" name="pre_address">
                                            @foreach($data->myAddress as $address)
                                                <option value="{{$address->id}}">{{$address->total_address}}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div id="newAddress">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" class="form-control" name="name"
                                                   @if(\Illuminate\Support\Facades\Auth::check() and Auth::user()->name) value="{{\Illuminate\Support\Facades\Auth::user()->name}}" @endif>
                                        </div><!-- End .col-sm-6 -->

                                        <div class="col-sm-6">
                                            <label>نام خانوادگی *</label>
                                            <input type="text" class="form-control" name="family"
                                                   @if(\Illuminate\Support\Facades\Auth::check() and Auth::user()->family) value="{{\Illuminate\Support\Facades\Auth::user()->family}}" @endif>
                                        </div><!-- End .col-sm-6 -->
                                    </div><!-- End .row -->
                                    ...
                                    <label>کشور *</label>
                                    <select class="form-control" name="country_id" onchange="getProvince()"
                                            id="country">
                                        @foreach($data->countries as $country)
                                            <option value="{{$country->id}}">{{$country->fa_name}}({{$country->en_name}}
                                                )
                                            </option>
                                        @endforeach
                                    </select>
